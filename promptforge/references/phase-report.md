...
| Rank | Cell ID | Template | Model | Temp | Mean Score | Std Dev | Cost/Call | Latency (ms) | Tokens In | Tokens Out |
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | cell-012 | t02-few-shot | claude-sonnet-4 | 0.3 | 8.74 | 0.31 | $0.0021 | 1240.5 | 312 | 156 |
| ... | | | | | | | |
...
**Best Model:** State which model produced the highest mean score. State which model produced the best score per dollar. State which model had the lowest latency.
...
| Combination | Mean Score | Cost/Call | Latency (ms) | Tokens In | Tokens Out | Notes |
|---|---|---|---|---|---|---|
| t01 + m01 + p01 | 7.2 | $0.0004 | 320.1 | 180 | 95 | Best budget option |
| t02 + m02 + p02 | 8.7 | $0.0021 | 1240.5 | 312 | 156 | Best balanced option |
| t03 + m03 + p02 | 9.1 | $0.0089 | 2810.3 | 520 | 280 | Best quality, premium cost |
